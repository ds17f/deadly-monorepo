...
* populate playback_start.source and search.selected_index (92a6a464)

### Bug Fixes
* pass source to playTrack in PlaylistServiceTests (287fd5e0)
...
* defer playback_start on restore until actual play (bc0db522)
* dedup repeated search emissions within 2s window (b389ca75)
...
* debounce playback_start to drop phantom track ramps (fc233bf0)
* send listened_ms and real duration_ms in playback_end (6074e41b)
...
### CI Changes
* App Store promote workflow + clear dependabot alerts (#30) (7f6558a4)
