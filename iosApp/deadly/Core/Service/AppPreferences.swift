...
final class AppPreferences {
    ...
    private static let devModeKey = "dev_mode"
    ...
    var devMode: Bool {
        didSet { UserDefaults.standard.set(devMode, forKey: Self.devModeKey) }
    }
    ...
    init() {
        ...
        devMode = UserDefaults.standard.bool(forKey: Self.devModeKey)
    }
}
