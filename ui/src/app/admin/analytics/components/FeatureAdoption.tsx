...
export default function FeatureAdoption({ data, onClick, onFeatureClick }: FeatureAdoptionProps) {
  ...
  return (
    ...
    >
      <h2 className="text-sm font-semibold text-zinc-400 uppercase tracking-wider mb-3 group-hover:text-zinc-200 transition-colors">
        Feature Adoption (30d) {onClick && <span className="text-zinc-600">&rarr;</span>}
      </h2>
