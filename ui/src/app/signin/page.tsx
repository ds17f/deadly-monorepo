    ...
    <div className="w-full max-w-sm rounded-xl border border-white/10 bg-deadly-surface p-8 shadow-lg">
      ...
      <form method="POST" action="/api/auth/signin/google">
        ...
        <button
          type="submit"
          disabled={!csrfToken}
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-800 transition hover:bg-gray-100 disabled:opacity-50"
        >
