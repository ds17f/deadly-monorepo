package com.grateful.deadly.core.media.state
...
class MediaControllerStateUtil @Inject constructor(
    ...
    fun createCurrentTrackInfoStateFlow(
        ...
        return combine(
            ...
            val playbackState = values[3] as com.grateful.deadly.core.model.PlaybackState
    ...
    fun createCurrentTrackInfo(
        ...
        recordingId: String?,
        showId: String?,
        playbackState: com.grateful.deadly.core.model.PlaybackState,
        position: Long,
        duration: Long
    ): CurrentTrackInfo {
